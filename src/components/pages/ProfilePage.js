...
export default function ProfilePage() {
 return (
  ...
  <div id="about-me" style={{ position: 'relative', backgroundImage: `url(${honey})`, opacity: 0.5, backgroundSize: 'cover', backgroundAttachment: 'fixed',  position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100vw', height: '100vh' }}>
      <Box>
